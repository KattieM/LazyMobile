...
class UserController extends Controller
{
    ...
    public function getProfileDetails($username)
    {
        ...
        return response()->json(["user_clicked_role"=>$user_clicked_role, "experience_count"=>$experience_count, "education_count"=>$education_count, "user_clicked"=>$user_clicked, "user_role"=>$user_role, "hr"=>$hr, "admin"=>$admin, "documents"=>$documents, "button"=>$button, "no_photo_upload"=>$no_photo_upload, "user"=>$user, "user_id"=>$user_id, "user_sys_role"=>$user_sys_role, "fb"=>$fb,"twitter"=>$twitter, "linked"=>$linked, "projects"=>$projects, "experiences"=>$experiences, "teams"=>$teams, "educations"=>$educations,  "page_name"=>$page_name]);
    }
