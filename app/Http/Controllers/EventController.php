...
class EventController extends Controller
{
    ...
    public function showDetails($name)
    {
        ...
        return response()->json(["review_btn"=>$review_btn,"goingAskOrg_btn"=>$goingAskOrg_btn,"reviews"=>$reviews, "num_attendees"=>$num_attendees, "button"=>$button, "event"=>$event,"location_name"=>$location_name, "language_name"=>$language_name, "organizer_name"=>$organizer_name, "organizer_username"=>$organizer_username, "organizer_surname"=>$organizer_surname, "organizer_position"=>$organizer_position,"organizer_email"=>$organizer_email, "organizer_photo"=>$organizer_photo, "attendees"=>$attendees, "going"=>$going,"page_name"=>$page_name]);
    }
